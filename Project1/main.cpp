...
// процедура ходьбы
	// |-|-|-|-|-|
	// |0 1 2 3|4 
	// int a; <- переменна€ типа инт
	// int *b; <- адресс в пам€ти, по которому лежит переменна€ типа инт
	...
	// B->Method();
	// Imba::Seth();
//методы измен€ют состо€ни€ обьектов
...
int main()
{
	...
	//window.setVerticalSyncEnabled(true); //вертикальна€ синхронизаци€
	...
	bool inventory_open = false; //состо€ние открытого инвентар€ 
	bool sost_walk = true; //состо€ние движени€ игрока
